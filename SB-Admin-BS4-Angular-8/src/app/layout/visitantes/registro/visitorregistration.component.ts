...
export class VisitorregistrationComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.visitante.departamento_expedicion = '';
        this.visitante.municipio_expedicion = '';
        this.visitante.rh = '';
    ...
    public departamentoChange() {
        this._parametricos_srv.getMunicipios(this.visitante.departamento_expedicion).subscribe((Municipios) => {
